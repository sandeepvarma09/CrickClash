  ...
  if (!username) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-20 text-center">
        <h2 className="text-2xl font-bold text-white mb-4">Please log in to see your challenges</h2>
  ...
  return (
    <div ref={containerRef} className="max-w-4xl mx-auto px-4 py-10">
      <div className="mb-10 text-center sm:text-left">
        ...
        <p className="text-slate-400">Track all your predictions and results in one place.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 card-glass">
          ...
          <p className="text-slate-400 mb-6">You haven't made any predictions. Start competing now!</p>
              ...
              <div key={pred._id} className="challenge-card opacity-0 group card-glass p-1 overflow-hidden transition-all duration-300 hover:border-orange-500/30">
                <div className="p-5 flex flex-col sm:flex-row items-center gap-6">
                  ...
                  <div className="shrink-0 text-center">
                    <div className={`w-16 h-16 rounded-3xl flex flex-col items-center justify-center font-black border-2
                      ${status === 'completed' 
                  ...
                  <div className="flex-1 text-center sm:text-left min-w-0">
                    ...
                    <p className="text-slate-500 text-xs mt-1">
                      {match?.format} · {new Date(pred.submittedAt).toLocaleDateString('en-IN', { day: 'numeric', month: 'short' })}
                    </p>
                  </div>
